...
public class RsaFunctionClass {
	/*
	 * USE THIS SEGMENT OF CODE IF DEPLOYING ON DYANAMIC SYSTEM Randomly generates
	 * Primes 'p','q'and'e' of indicated length-- static private int LENp = 1000;
	 * //latest systems use between 1000-1024bits each for p and q which means
	 * 2024bits for n static private int LENq = 990; static private int LENe = 1010;
	 * //must be >p and q but<p+q static private Random rand =new Random(); static
	 * BigInteger p = BigInteger.probablePrime(LENp, rand); //get random prime no
	 * For static BigInteger q = BigInteger.probablePrime(LENq, rand); //get random
	 * prime no of length LENq static BigInteger e = BigInteger.probablePrime(LENe,
	 * rand); //get random prime no of length LENe
	 * 
	 */
