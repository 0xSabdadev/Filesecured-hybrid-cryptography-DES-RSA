  ...
  <center>
    <div id="login" style="width:30%; ">
      ...
      <form method="post" action="login.jsp" style="display: inline; ">
        ...
        <input type="text" name="uname" value="" placeholder="User Name" title="username" minlength="4" maxlength="30"
          required /><br />
        <input type="password" name="pass" value="" placeholder="Password" title="password" minlength="6" maxlength="40"
          required /><br />
